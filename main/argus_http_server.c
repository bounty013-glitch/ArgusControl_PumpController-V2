...
static const char PORTAL_HTML[] =
    ...
    "row('STA State',n.sta_state,nc(n.sta_state))+"
    ...
    "(n.last_error_category!=='NONE'?row('Last Failure',n.last_error_category+' ('+n.last_disconnect_reason_name+')','badge-warn'):'')+"
    "(n.retry_count>0?row('Failures',n.retry_count,'badge-err'):'')+"
    "(n.seconds_until_retry>0?row('Retry In',n.seconds_until_retry+'s','badge-warn'):'')+"
    "row('Guidance',n.operator_guidance,n.operator_action_required?'badge-err':'badge-ok');"
