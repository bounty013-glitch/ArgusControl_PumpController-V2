...
Execute this checklist only against the Phase 4B.3a candidate identified as `v2-phase4b.3a-dev`. The dashboard identity must display that value once, without duplicated bracketed application-version text.
