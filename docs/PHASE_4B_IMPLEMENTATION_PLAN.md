...
**Status:** Phase 4B.1 through Phase 4B.3, including Phase 4B.3a, are COMPLETE AND ACCEPTED. Phase 4B.4 is ACTIVE; Step 1 strict request contract and pure decoder are implemented, with live admission and dispatch still pending.
...
**Status:** ACTIVE - Step 1 strict request contract and pure decoder implemented; runtime execution, live admission, HTTP registration, router dispatch, and physical acceptance remain pending. See [Phase 4B.4 Implementation Plan](Phase%204B.4%20-%20Implementation%20Plan%20-%20Browser-Local%20Motion%20Command%20API.md).
